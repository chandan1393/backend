    ...
    public void sendInstallmentReminders() {
        ...
        for (PaymentInstallment inst : due) {
            try {
                ...
                // Email reminder
                email.paymentDueTomorrow(student.getEmail(), student.getFullName(), course, inst.getInstallmentNumber(), amount, inst.getDueDate().toString(), inst.getStripePaymentLink());
